...
namespace MoreLinq.Test
{
    ...
    public class SlidingWindowTests
    {
        ...
        {
            new BreakingSequence<int>().SlidingWindow(1);
        }
        ...
        public void TestSlidingWindowEmptySequence()
        {
            ...
            var result = sequence.SlidingWindow(5);
        ...
        public void TestSlidingWindowOfSingleElement()
        {
            ...
            var result = sequence.SlidingWindow(1);
        ...
        public void TestSlidingWindowLargerThanSequence()
        {
            const int count = 100;
            var sequence = Enumerable.Range(1, count);
            var result = sequence.SlidingWindow(count + 1);
        ...
        public void TestSlidingWindowSmallerThanSequence()
        {
            ...
            var sequence = Enumerable.Range(1, count);
            var result = sequence.SlidingWindow(windowSize);
