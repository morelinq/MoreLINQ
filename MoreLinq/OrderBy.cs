...
namespace MoreLinq
{
    ...
    public static partial class MoreEnumerable
    {
        ...
        public static IOrderedEnumerable<T> OrderBy<T, TKey>(this IEnumerable<T> source, Func<T, TKey> keySelector, [CanBeNull] IComparer<TKey> comparer, OrderByDirection direction)
        {
        ...
        public static IOrderedEnumerable<T> ThenBy<T, TKey>(this IOrderedEnumerable<T> source, Func<T, TKey> keySelector, [CanBeNull] IComparer<TKey> comparer, OrderByDirection direction)
        {
            return direction == OrderByDirection.Ascending
