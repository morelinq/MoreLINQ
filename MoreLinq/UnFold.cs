...
namespace MoreLinq
{
    ...
    static partial class MoreEnumerable
    {
        ...
        /// Function that takes a state and produces an object containing all 
        ...
        /// Function to select the state from the current input.
        /// </param>
        /// <param name="resultSelector">
        /// Function to select the result from the current input.
        /// </param>
