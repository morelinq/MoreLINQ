...
namespace MoreLinq.Extensions
{
    ...
    public static partial class ScanByExtension
    {
        ...
        /// source sequence, its key and the current state for that key.
        /// </summary>
        /// <typeparam name="TSource">Type of the elements of the source sequence.</typeparam>
        ...
        public static IEnumerable<TResult> ScanBy<TSource, TKey, TState, TResult>(
            ...
            => MoreEnumerable.ScanBy(source, keySelector, seedSelector, accumulator, resultSelector);
        ...
        public static IEnumerable<TResult> ScanBy<TSource, TKey, TState, TResult>(
            ...
            Func<TSource, TKey, TState, TResult> resultSelector,
            IEqualityComparer<TKey> comparer)
            => MoreEnumerable.ScanBy(source, keySelector, seedSelector, accumulator, resultSelector, comparer);
