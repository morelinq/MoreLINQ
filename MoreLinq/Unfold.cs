...
namespace MoreLinq
{
    ...
    static partial class MoreEnumerable
    {
        ...
        /// Function that takes a state and computes a triplet of Boolean, the next state and
        /// element of the sequence. The Boolean value indicates whether the sequence should
        /// continue or not. If <c>false</c>, the sequence ends and the second (next state) and
        /// third (next element) items of the triplet are ignored.
        /// </param>
        /// <returns>
            ...
            Func<TState, (bool Continue, TState State, TResult Result)> generator)
        {
            ...
            return Unfold(state, generator, e => e.Continue, e => e.State, e => e.Result);
        }
