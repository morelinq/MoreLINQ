...
namespace MoreLinq
{
    ...
    public static partial class MoreEnumerable
    {
        ...
        public static IEnumerable<TSource> SortedMerge<TSource>(this IEnumerable<TSource> source, OrderByDirection direction, [CanBeNull] IComparer<TSource> comparer, params IEnumerable<TSource>[] otherSequences)
        {
